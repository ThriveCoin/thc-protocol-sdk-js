...
exports.ThriveStaking = exports.ThriveStakingEventEnum = exports.ThriveStakingType = void 0;
const ethers_1 = require("ethers");
const events_1 = require("events");
const ThriveStakingNative_json_1 = __importDefault(require("./abis/ThriveStakingNative.json"));
...
})(ThriveStakingType || (exports.ThriveStakingType = ThriveStakingType = {}));
var ThriveStakingEventEnum;
...
})(ThriveStakingEventEnum || (exports.ThriveStakingEventEnum = ThriveStakingEventEnum = {}));
class ThriveStaking {
    constructor(params, stakingType = ThriveStakingType.IERC20) {
        ...
        this.initContract();
        const eventAbis = [
            ...ThriveStakingNative_json_1.default.filter((item) => item.type === 'event'),
    ...
    initContract() {
        ...
        if (this.stakingType === ThriveStakingType.NATIVE) {
            this.contract = new ethers_1.ethers.Contract(this.nativeAddress, ThriveStakingNative_json_1.default, signerOrProvider);
        }
        else {
            this.contract = new ethers_1.ethers.Contract(this.ierc20Address, ThriveStakingIERC20_json_1.default, signerOrProvider);
        }
    }
    setWallet(wallet) {
        this.wallet = wallet;
    ...
    async calculateYield(address) {
        ...
        return {
            claimableYield: ethers_1.ethers.formatEther(claimableYield),
            ongoingYield: ethers_1.ethers.formatEther(ongoingYield)
        };
    }
    async getClaimableYieldInStorage(address) {
        ...
        return ethers_1.ethers.formatEther(claimableYield);
    }
    ...
    async approve(amount) {
        ...
        const tokenContract = new ethers_1.ethers.Contract(this.token, [
...
exports.ThriveStaking = ThriveStaking;
