...
exports.ThriveReview = exports.ThriveReviewEventEnum = void 0;
...
})(ThriveReviewEventEnum || (exports.ThriveReviewEventEnum = ThriveReviewEventEnum = {}));
/* -------------------------------
...
class ThriveReview {
    ...
    constructor(_factoryAddress, _wallet, _provider, _contractAddress) {
        ...
        this.factoryContract = new ethers_1.ethers.Contract(this.factoryAddress, ThriveReviewFactory_json_1.default, this.wallet ?? this.provider);
        if (this.contractAddress) {
            this.contract = new ethers_1.ethers.Contract(this.contractAddress, ThriveReview_json_1.default, this.wallet ?? this.provider);
        }
        this.eventInterface = new ethers_1.ethers.Interface((ThriveReview_json_1.default).filter((x) => x.type === 'event'));
